...
% \usepackage{tabularx}
\usepackage{ltablex} % Must be added after tabularx ?
...
\newcommand*{\InvoiceTitle}{
	...
	% 	% Add the "invoice" title
		...
		\end{center}
	% 	\normalsize
	% 	% Add mandatory invoice references
	% 	\begin{tabular}{ll}
	% 		\color{subduedColor}Num : & \#\InvoiceNumber \cr
	% 		\color{subduedColor}Date : & \InvoiceDate \cr

	% 		\ifdefempty{\CompanyInternalRef}{}{
	% 			\color{subduedColor}Notre ref : & \CompanyInternalRef \cr
	% 		}

	% 		\ifdefempty{\ClientInternalRef}{}{
	% 			\color{subduedColor}Votre ref : & \ClientInternalRef \cr
	% 		}
	% 	\end{tabular}
	\end{minipage}
}
...
{
	{
		...
		\begin{tabularx}{\textwidth}{Xrrr}
			...
			\textbf{\itemizationHeaderStyle Désignation ~~~~~~}	& \textbf{\itemizationHeaderStyle P.U. (\euro HT)}	& \textbf{\itemizationHeaderStyle Qté.}	& \textbf{\itemizationHeaderStyle Total (\euro HT)} \\\midrule \endfirsthead
			% Set the "continued" table header
			\textit{(continued)} \\
			\textbf{\itemizationHeaderStyle Désignation ~~~~~~}	& \textbf{\itemizationHeaderStyle P.U. (\euro HT)}	& \textbf{\itemizationHeaderStyle Qté.}	& \textbf{\itemizationHeaderStyle Total (\euro HT)} \\\midrule \endhead
			% \midrule
			\showrowcolors
